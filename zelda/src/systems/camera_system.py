...
class Camera:
    ...
    def custom_draw(self):
        ...
        for layer in LAYERS.values():
            for sprite in sorted(self.drawable_sprites.sprites(), key=lambda s: s.rect.centery):
                if sprite.z == layer:
    ...
    def enemy_update(self, player):
        enemy_sprites = [sprite for sprite in self.drawable_sprites.sprites() if hasattr(sprite, 'sprite_type')
